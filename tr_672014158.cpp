...
// bagian kaca
 ...
 //kiri
    ...
    glBegin(GL_QUADS);
    glColor3f(0.50, 0.50, 0.50);
    glVertex3f(10.0, 0.0, 156.0);
    glVertex3f(10.0, 31.5, 156.0);
    glVertex3f(10.0, 31.5, 160.0);
    glVertex3f(10.0, 0.0, 160.0);
    glEnd();
...
// tembok masuk smpng blakang
    ...
    glVertex3f(35.1, 13.0, -140.0);
    glVertex3f(35.1, 13.4, -140.0);
    glVertex3f(35.1, 13.4, -136.0);
    glVertex3f(35.1, 13.0, -136.0);
    glEnd();
    glBegin(GL_QUADS);
    glColor3f(0.5, 0.5, 0.5);
    glVertex3f(35.1, 17.8, -140.0);
    glVertex3f(35.1, 18.2, -140.0);
    glVertex3f(35.1, 18.2, -136.0);
    glVertex3f(35.1, 17.8, -136.0);
    glEnd();
    glBegin(GL_QUADS);
    glColor3f(0.5, 0.5, 0.5);
    glVertex3f(35.1, 21.2, -140.0);
    glVertex3f(35.1, 21.6, -140.0);
    glVertex3f(35.1, 21.6, -136.0);
    glVertex3f(35.1, 21.2, -136.0);
    glEnd();
    glBegin(GL_QUADS);
    glColor3f(0.5, 0.5, 0.5);
    glVertex3f(35.1, 24.0, -140.0);
    glVertex3f(35.1, 24.4, -140.0);
    glVertex3f(35.1, 24.4, -136.0);
    glVertex3f(35.1, 24.0, -136.0);
    glEnd();
    glBegin(GL_QUADS);
    glColor3f(0.5, 0.5, 0.5);
    glVertex3f(35.1, 27.8, -140.0);
    glVertex3f(35.1, 28.2, -140.0);
    glVertex3f(35.1, 28.2, -136.0);
    glVertex3f(35.1, 27.8, -136.0);
    glEnd();
